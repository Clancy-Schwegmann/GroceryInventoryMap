...
function enqueue_fly_in_effect_script() {
    wp_enqueue_script("fly-in-effect", get_stylesheet_directory_uri() . "/scripts/fly-in-effect.js", array("jquery"), null, true);
    wp_localize_script("fly-in-effect", "ajaxurl", array("ajaxurl" => admin_url("admin-ajax.php"))); //make sure we can pass-in variables to JavaScript as well.
}
...
add_action("wp_enqueue_scripts", "enqueue_fly_in_effect_script");
